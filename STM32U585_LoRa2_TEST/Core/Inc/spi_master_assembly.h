...
extern void ASM_SPI_CFG2_SSOE_0(void);
extern void ASM_SPI_CFG2_SSOM_1(void);
extern void ASM_SPI_CFG2_SSOM_0(void);
extern void ASM_SPI_CFG2_MIDI_Set(uint32_t x);
extern void ASM_SPI_CFG2_MSSI_Set(uint32_t x);
...
extern void ASM_SPI_CFG1_FTHLV(uint32_t x);
extern void ASM_SPI_CR1_SPE_1(void);
extern void ASM_SPI_CR1_CSTART_1(void);
extern uint32_t ASM_SPI_TXDR_Set(uint8_t x);
